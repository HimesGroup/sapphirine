...
ui <- fluidPage(
  ...
  tabsetPanel(type = "tabs",
    ...
    tabPanel(strong("Sensor and Geospatial Data"),
      ...
      hidden(
        ...
        fluidRow(id = 'Instructions_1',
          ...
          tags$p("Click on \"Download data\" to download all sensor and crime data fitting the set parameters. 
        ...
        fluidRow(
          ...
          column(3,
                 ...
                 fluidRow(
                   ...
                   column(4, downloadButton('download', 'Download data'))
                 )
      ...
      h6(HTML('&#8287')),
      downloadButton('all_maps_download', 'Download figure'))),
    ...
    ), #End sensor-based tab panel
    
    tabPanel(strong("EPA Data"),

      br(),       
       
      fluidRow(
         HTML('&#8287&#8287&#8287&#8287'), #Adds spaces
         actionButton('Instructions_b2', 'Show/Hide Instructions')
      ),
      ...
      hidden(
        ...
        fluidRow(id = 'Instructions_2',

          column(12,
            tags$p("Select a year and pollutant for which to view annually averaged data from the U.S. Environmental 
                   Protection Agency (EPA). EPA monitor locations are indicated by blue dots, and the map estimates
                   are calculated using inverse-distance-weighted interpolation. Click \"Go\" to display the map."),
           tags$p("Click on the ruler icon to measure physical distances on the map, and click on the crosshair icon to recenter the map.
                    The latitude and longitude corresponding to the cursor position are shown above the top left corner of the map, which is useful for selecting the desired geographic scope of the display.
                    To take a screenshot of the map, use Windows+PrtSc (Windows) or Shift+Command+5 (Mac)."),
           tags$p("Click on \"Download data\" to download all EPA monitor data for the data range and variable. 
                    Be sure to click \"Go\" before attempting to download data, as the data to be downloaded correspond to those rendered on the map.")
          )
        )
      ),
      ...
      wellPanel(
        ...
        fluidRow(
          ...
          column(4,
                 dateRangeInput("EPA_dates", label = "Date range", 
                                start = "2015-06-01", end = "2019-12-31", 
                                startview = "decade",
                                min = "2015-06-01", max = "2019-12-31"),
                 ),
          column(4,
          ...
          column(2,
                 h6(HTML('&#8287')),
                 downloadButton('EPA_download', 'Download data')
                 )
        )
